        ...
        <div className='ProfilePage'>
            <div className="ProfileContainer">
                ...
                <div className="blog-details">
                    <h2>User Details</h2>
                    <ul>
                        <li><span className='hoverBG'>Username : {userInfo.username}</span></li>
                        <li><span className='hoverBG'>Email : {userInfo.email}</span></li>
                        <li><span className='hoverBG'>Total Blogs Posted: {postCount}</span></li>
                        <li ><span><button className='ProfileBTN' onClick={ResetPassword}>Reset Password</button></span></li>
